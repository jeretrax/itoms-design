...
The [GRC Solutions Landscape Summary mockup](mockups/grc-solutions-landscape-summary.html) is the accepted target experience and capability-coverage goal for GRC. Future interfaces may divide or adapt the presentation by role, scope, device, Work Function, or Workspace, but they must collectively preserve its full-landscape visibility, Current/Planned/Target comparison, adoption and service choices, cross-framework traceability, and drill-down to evidence and work. The oversized canvas and generated entries remain illustrative rather than a mandatory final layout or normative control catalog.
