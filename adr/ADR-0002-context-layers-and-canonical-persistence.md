...
ITOMS maintains one Canonical Data layer. Organization Profile, Operating Model, Lens, Capabilities, Permissions, and Current Scope are applied to that layer to produce Effective Context for a request or session.
...
- Capabilities define available functions; Permissions determine whether the current actor may use them within the resolved scope.
- Screen layout and navigation remain presentation concerns and do not define Canonical Data.
